...
@section('content')
    ...
    <div class="cart-section container">
        <div>
            ...
            <h2>{{ Cart::count() }} Producto(s) en Carrito</h2>
                    ...
                    <div class="cart-table-row-right">
                        <div class="cart-table-actions">
                            <form action="{{ route('cart.destroy', $item->rowId) }}" method="POST">
                                ...
                                <button type="submit" class="alert-danger">Remover</button>
                            </form>                            
                        </div>
                        <div>
            ...
            @if (! session()->has('coupon'))
                ...
                <div class="have-code"> ¿Tiene un CUPON?</div>
            ...
            <div class="cart-totals">
                <div class="cart-totals-left">
                    En SHOP-CART el envio es GRATIS!!!.
                </div>
            ...
            <div class="cart-buttons">
                ...
                <a href="{{ route('checkout.index') }}" class="button-primary">Proceda con el pago</a>
            </div>
            ...
            <h2>{{ Cart::instance('saveForLater')->count() }} Producto(s) guardado(s) para despues</h2>
