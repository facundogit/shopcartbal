        ...
        <div class="checkout-section">
            <div>
                <form action="{{ route('checkout.store') }}" method="POST" id="payment-form">
                    ...
                    <div class="form-group">
                        <label for="name_on_card">Nombre en Tarjeta</label>
                    ...
                    <button type="submit" id="complete-order" class="button-primary full-width">Pedido Completo</button>
                ...
                @if ($paypalToken)
                    ...
                    <div class="mt-32">
                        ...
                        <form method="post" id="paypal-payment-form" action="{{ route('checkout.paypal') }}">
                            ...
                            <button class="button-primary" type="submit"><span>Pagar con PayPal</span></button>
                        </form>
                    </div>
                @endif
            </div>
